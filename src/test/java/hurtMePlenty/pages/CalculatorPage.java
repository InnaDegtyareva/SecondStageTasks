...
public class CalculatorPage extends AbstractPage {
    ...
    private static final String DATACENTER_LOCATION_LOCATOR_PATTERN = "(//*[contains(@ng-repeat,'fullRegionList') and @value='%s'])[2]";
    ...
    public CalculatorPage clickOnInstancesAreaAndSelect() {
        instancesArea.click();
        instancesArea.sendKeys("4");
        return this;
    }
    ...
    public CalculatorPage clickOnCommittedUsageAreaAndSelect(CommitedUsage commitedUsage) {
        committedUsageArea.click();
        selectValueFromTheList(COMMITTED_USAGE_LOCATOR_PATTERN, commitedUsage);
        return this;
    }
    ...
    public <E extends Enum<E>> void selectValueFromTheList(String patternLocator, E enumList) {
        driver.findElement(By.xpath(String.format(patternLocator, enumList))).click();
    }
